...
In order to recreate Figure 3 the data was missing for the Florida and Ocean waters samples. The catergories of the subphylum were also missing as well as the parameters used to create the heatmaps and the dendrogram. I emailed the corresponding author asking for further data and the code:
...
Dr. Biddle forwarded the email on to the lead wuthor, from whom I waited another week for a response.
...
## Heatmaps
I learned hot to put the data into a matrix and shift the columns to get the x-axis value of OTU ID that I desired. I applied a Kulczynski dissimilarity index to the data but had no way of knowing if they also applied the Bray-Curtis to the same data at some stage as well. 
